  ...
  return (
    <>
      ...
      <a
        ...
        className="blantershow-chat fixed bottom-8 left-8 bg-[#25d366] text-white px-1.5 py-0.5 rounded-full shadow-lg flex items-center gap-0.5 hover:bg-[#1ea952] transition-colors z-40 text-[10px] whitespace-nowrap"
        target="_blank"
