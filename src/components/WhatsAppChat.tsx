...
export const WhatsAppChat = () => {
  ...
  const phoneNumber = '923461115757'; // Updated phone number
  const presetMessage = 'Directly Contact our CEO!'; // Updated message
      ...
      <div id="whatsapp-chat" className={isVisible ? 'show' : 'hide'}>
        <div className="whatsapp-chat-header">
          <div className="whatsapp-chat-avatar">
            <img src="https://i.ibb.co/s90nbwpr/techrealm-logo.jpg" alt="Company Logo" />
          </div>
          <p>
