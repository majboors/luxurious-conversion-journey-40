  ...
  return (
    <>
      ...
      <a
        ...
        className="blantershow-chat fixed bottom-8 left-8 bg-[#25d366] text-white px-2 py-1 rounded-full shadow-lg flex items-center gap-1 hover:bg-[#1ea952] transition-colors z-40 text-xs whitespace-nowrap"
        target="_blank"
